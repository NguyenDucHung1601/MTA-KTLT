...
int main(){
	...
	printf("-- Exercise 6: ADD ELEMENT (in Double linked list) _ NguyenDucHung --\n\n");
	printf(" - Number of List element : ");
	scanf("%d",&n);
	int a[n];
	creatData(a,n);
	writeData("input6.txt",a,n);
	readData("input6.txt",a,n);
	// xuat ket qua ra file output
	FILE *fout;
	fout = fopen("output6.txt","a");
	//
