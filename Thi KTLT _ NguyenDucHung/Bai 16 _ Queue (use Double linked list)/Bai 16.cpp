...
// CAU TRUC DU LIEU QUEUE (sd DSLK kep)
...
int main(){
	...
	printf("-- Exercise 16: QUEUE (use Double linked list) _ NguyenDucHung --\n");
	printf("\nMax size of Queue: "); 	scanf("%d",&maxsize);
	
	int a[maxsize];
	creatData(a,maxsize);
	writeData("input16.txt",a,maxsize);
	readData("input16.txt",a,maxsize);
